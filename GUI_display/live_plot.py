...
class MultiLivePlot(QObject):
    plot_updated = pyqtSignal()  # 用于通知主线程更新图表
    ...
    def __init__(self, mode=1):
        ...
        plt.switch_backend('Qt5Agg')  # 确保使用Qt5后端
        ...
        if manager is not None:
            manager.window.hide()  # 隐藏窗口，等待主线程显示
